    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">81.5% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>282/346</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>180/241</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>280/340</span>
            </div>
...
<a name='L1074'></a><a href='#L1074'>1074</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
const clearPopup = () =&gt; {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (dcent.popupWindow) {
    dcent.popupWindow = undefined
    <span class="missing-if-branch" title="if path not taken" >I</span>if (dcent.popupTab) {
<span class="cstat-no" title="statement not covered" >      dcent.popupTab = undefined</span>
    }
    dcent.dcentWebPromise = dcent.dcentWebDeferred()
    ee.emit('popUpClosed')
...
&nbsp;
   ...
   const extension = typeof chrome !== 'undefined' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >chrome.runtime </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >typeof chrome.runtime.onConnect !== 'undefined'</span>
   <span class="missing-if-branch" title="else path not taken" >E</span>if (!extension) {
...
<span class="cstat-no" title="statement not covered" >        LOG.debug('create iframe') </span>
        const dcentIframe = <span class="cstat-no" title="statement not covered" >document.getElementById('dcent-connect')</span>
<span class="cstat-no" title="statement not covered" >        if (dcentIframe) {</span>
<span class="cstat-no" title="statement not covered" >          dcentIframe.parentNode.removeChild(dcentIframe)</span>
        }
<span class="cstat-no" title="statement not covered" >        dcent.iframe = document.createElement('iframe')</span>
<span class="cstat-no" title="statement not covered" >        dcent.iframe.src = dcentConfig.popUpUrl + '/iframe'</span>
<span class="cstat-no" title="statement not covered" >        dcent.iframe.id = 'dcent-connect'</span>
<span class="cstat-no" title="statement not covered" >        document.body.appendChild(dcent.iframe)</span>
<span class="cstat-no" title="statement not covered" >        dcent.popupWindow = dcent.iframe.contentWindow</span>
<span class="cstat-no" title="statement not covered" >        if (dcent.popupTab) {</span>
<span class="cstat-no" title="statement not covered" >          dcent.popupTab = undefined</span>
        }
<span class="cstat-no" title="statement not covered" >        return null</span>
    }
  } catch (e) {
    return popupErrorException(e || <span class="branch-1 cbranch-no" title="branch not covered" >e.message)</span>
  }
  return null
}
&nbsp;
...
&nbsp;
    const popUpClosedListener = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      reject(dcent.dcentException('pop-up_closed', 'Pop-up windows has been closed'))</span>
    }
&nbsp;
    const timeOutCall = () =&gt; {
...
&nbsp;
    const eventEmitListener = (messageEvent) =&gt; {
      ...
      if (messageEvent.data.payload.header.status === 'success') {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (messageEvent.data.payload.body.command === 'transaction' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >messageEvent.data.payload.body.error.code === 'user_cancel')</span> {
<span class="cstat-no" title="statement not covered" >          resolve(messageEvent.data.payload)</span>
        } else {
...
&nbsp;
const createDcentTab = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >  LOG.debug('createDcentTab')</span>
<span class="cstat-no" title="statement not covered" >  if (typeof chrome === 'undefined') <span class="cstat-no" title="statement not covered" >return</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (dcent.popupTab !== undefined &amp;&amp; dcent.popupTab !== null) <span class="cstat-no" title="statement not covered" >return </span></span>
&nbsp;
  const url = <span class="cstat-no" title="statement not covered" >dcentConfig.popUpUrl + '?_from_extension=true'</span>
  // eslint-disable-next-line no-undef
<span class="cstat-no" title="statement not covered" >  chrome.windows.getCurrent(null, <span class="fstat-no" title="function not covered" >fu</span>nction (currentWindow) {</span>
<span class="cstat-no" title="statement not covered" >    if (currentWindow.type !== 'normal') {</span>
      // eslint-disable-next-line no-undef
<span class="cstat-no" title="statement not covered" >      chrome.windows.create({</span>
        url: url
      }, <span class="fstat-no" title="function not covered" >fu</span>nction (newWindow) {
        // eslint-disable-next-line no-undef
<span class="cstat-no" title="statement not covered" >        chrome.tabs.query({</span>
          windowId: newWindow.id,
          active: true
        }, <span class="fstat-no" title="function not covered" >fu</span>nction (tabs) {
<span class="cstat-no" title="statement not covered" >           LOG.debug('create window and tab')</span>
<span class="cstat-no" title="statement not covered" >           dcent.popupTab = tabs[0]</span>
        })
      })
    } else {
       // eslint-disable-next-line no-undef
...
<span class="cstat-no" title="statement not covered" >        if (tabs.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >          index = tabs[0].index + 1</span>
        }
        // eslint-disable-next-line no-undef
<span class="cstat-no" title="statement not covered" >        chrome.tabs.create({</span>
          url: url,
          index: index
        }, <span class="fstat-no" title="function not covered" >fu</span>nction (tab) {
<span class="cstat-no" title="statement not covered" >          dcent.popupTab = tab</span>
        })
      })
    }
  })
...
&nbsp;
  if (
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (messageEvent.data.payload === 'dcent-iframe-init') {
<span class="cstat-no" title="statement not covered" >      dcent.eventSource = messageEvent.source</span>
<span class="cstat-no" title="statement not covered" >      createDcentTab()</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (messageEvent.data.payload === 'dcent-connected' ||
...
<span class="cstat-no" title="statement not covered" >    if (dcent.popupTab &amp;&amp; dcent.popupTab.id) {</span>
      // eslint-disable-next-line no-undef
<span class="cstat-no" title="statement not covered" >      chrome.tabs.remove(dcent.popupTab.id, <span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        dcent.popupWindow = undefined</span>
<span class="cstat-no" title="statement not covered" >        dcent.popupTab = undefined</span>
      })
    }
    const dcentIframe = <span class="cstat-no" title="statement not covered" >document.getElementById('dcent-connect')</span>
...
<span class="cstat-no" title="statement not covered" >    clearPopup()</span>
  }
}
&nbsp;
const postMessage = (message) =&gt; {
  if (dcent.popupWindow) {
    try {
      let origin = '*' 
      <span class="missing-if-branch" title="if path not taken" >I</span>if (dcent.iframe) {
        // eslint-disable-next-line no-useless-escape
<span class="cstat-no" title="statement not covered" >        origin = dcent.iframe.src.match(/^.+\:\/\/[^\/]+/)[0]</span>
      } 
...
&nbsp;
const isHexNumberString = <span class="fstat-no" title="function not covered" >(s</span>tr) =&gt; {
<span class="cstat-no" title="statement not covered" >  if (/^(0x)?[0-9a-f]+$/.test(str.toLowerCase())) {</span>
...
const checkParameter = (type, param) =&gt; {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (type === 'numberString') {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof param !== 'string') <span class="cstat-no" title="statement not covered" >throw dcent.dcentException('param_error', 'Invaild Parameter - ' + param) </span>// must string
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (param.indexOf('0x', 0) === -1) {
      // number string
      if (isNumberString(param)) return param
    } else <span class="cstat-no" title="statement not covered" >if (param.indexOf('0x', 0) === 0) {</span>
      // hex string
<span class="cstat-no" title="statement not covered" >      if (isHexNumberString(param)) <span class="cstat-no" title="statement not covered" >return param</span></span>
    }
...
<span class="branch-0 cbranch-no" title="branch not covered" >    case dcentCoinGroup.BITCOIN.toLowerCase():</span>
<span class="branch-1 cbranch-no" title="branch not covered" >    case dcentCoinGroup.BITCOIN_TESTNET.toLowerCase():</span>
<span class="branch-2 cbranch-no" title="branch not covered" >    case dcentCoinGroup.MONACOIN.toLowerCase():</span>
<span class="branch-3 cbranch-no" title="branch not covered" >    case dcentCoinGroup.MONACOIN_TESTNET.toLowerCase():    </span>
...
function isTokenType (coinGroup) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!coinGroup) {
<span class="cstat-no" title="statement not covered" >    return false</span>
  }
  switch (coinGroup.toLowerCase()) {
    case dcentCoinGroup.ERC20.toLowerCase():
 ...
 */
dcent.selectAddress = <span class="fstat-no" title="function not covered" >as</span>ync function (addresses) {
<span class="cstat-no" title="statement not covered" >  if (!Array.isArray(addresses)) {</span>
<span class="cstat-no" title="statement not covered" >    throw dcent.dcentException('param_error', 'addresses is not array')</span>
  }
<span class="cstat-no" title="statement not covered" >  return await dcent.call({</span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (transaction === null || typeof transaction === 'undefined') {
<span class="cstat-no" title="statement not covered" >    throw dcent.dcentException('param_error', 'transaction object is undefined or null')</span>
  }
&nbsp;
...
&nbsp;
  switch (coinType.toLowerCase()) {
    ...
    case dcentCoinType.RSK_TESTNET.toLowerCase():
      break
<span class="branch-4 cbranch-no" title="branch not covered" >    case dcentCoinType.XDC.toLowerCase():</span>
<span class="branch-5 cbranch-no" title="branch not covered" >    case dcentCoinType.XDC_APOTHEM.toLowerCase():</span>
<span class="cstat-no" title="statement not covered" >      to = XDCPrefixConverter(to)</span>
...
&nbsp;
  switch (token.toLowerCase()) {
    ...
    case dcentCoinGroup.KCT_BAOBAB.toLowerCase():
      break
<span class="branch-6 cbranch-no" title="branch not covered" >    case dcentCoinType.XRC20.toLowerCase():</span>
<span class="branch-7 cbranch-no" title="branch not covered" >    case dcentCoinType.XRC20_APOTHEM.toLowerCase():</span>
<span class="cstat-no" title="statement not covered" >      contract.to = XDCPrefixConverter(contract.to)</span>
<span class="cstat-no" title="statement not covered" >      contract.address = XDCPrefixConverter(contract.address)</span>
<span class="cstat-no" title="statement not covered" >      break</span>
    default:
...
dcent.getKlaytnSignedTransaction = async function (
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!from) {
    const addressResponse = await this.getAddress(coinType, key)
    <span class="missing-if-branch" title="else path not taken" >E</span>if (addressResponse.body.parameter.address) {
...
&nbsp;
dcent.getSignedData = <span class="fstat-no" title="function not covered" >as</span>ync function (key, message) {
<span class="cstat-no" title="statement not covered" >  return await dcent.call({</span>
...
dcent.getXrpSignedTransaction = async function (transaction, key) {
  try {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof dcentXrpTxType[transaction.TransactionType] === 'undefined') {
<span class="cstat-no" title="statement not covered" >      throw dcent.dcentException('param_error', 'Invalid Transaction Type: ' + transaction.TransactionType)</span>
    }
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Dec 21 2021 14:19:28 GMT+0900 (대한민국 표준시)
            </div>
        </div>
