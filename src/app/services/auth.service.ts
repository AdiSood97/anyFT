...
export class AuthService {
  ...
  signUp(userData: Object) {
    ...
    let user = userData
    console.log(user, 'ang service')
    return this._HTTP.post(this.BASE_API_URL + '/sign-up',  {user: user }).toPromise()
  }

  startUp(accountId: Object) {
    return this._HTTP.post(this.BASE_API_URL + '/start-up',  accountId ).toPromise()
  }
